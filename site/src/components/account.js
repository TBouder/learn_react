...
/*   Updated: 2016/10/10 15:34:05 by tbouder          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
export default class account extends React.Component
{
	constructor()
	{
		...
		this.ft_send_account = this.ft_send_account.bind(this);
	}
	...
	ft_send_account()
	{
		...
		auth.createUserWithEmailAndPassword(THIS.state.email, THIS.state.passwd)
		.then(function(user)
		{
				...
				<div className="text_center padding_five page_center">
					...
					<div className="ui cards centered">
						<div className="card">
							...
							<div className="ui bottom attached button" onClick={this.ft_send_account.bind(this)}>
								Connect
							</div>
						</div>
					</div>
